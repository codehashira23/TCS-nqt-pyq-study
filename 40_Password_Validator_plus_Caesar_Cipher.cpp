/*
   TCS NQT PYQ 40: Password Validator + Caesar Cipher
   Source: Verified PYQ
   Exam/Shift: 8 May 2024 (Advanced)
   Difficulty: Medium
   Topics: String, Validation, Cipher

   QUESTION
   Take a string 'password' as input and first validate it according to several rules. If valid, apply a Caesar Cipher shift by N positions on letters and digits and output the encrypted string. If invalid, print "Error!".
