/*
   TCS NQT PYQ 19: Smallest Number in Array
   Source: Verified PYQ
   Exam/Shift: 29 April 2024 Shift 1
   Difficulty: Easy
   Topics: Array
...
int main(){int n; cin>>n; long long mn=LLONG_MAX,x; while(n--){cin>>x; mn=min(mn,x);} cout<<mn<<"\n";}
