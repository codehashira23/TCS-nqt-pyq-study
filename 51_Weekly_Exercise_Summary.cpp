/*
   TCS NQT PYQ 51: Weekly Exercise Summary
   Source: Verified PYQ
   Difficulty: Easy
   Topics: Simulation

   QUESTION
   Design a weekly exercise summary. Given the number of minutes of daily exercise for 7 consecutive days, calculate the total exercise duration for the week and the average daily workout duration.
...
int main(){double total=0,x; for(int i=0;i<7;i++){cin>>x; total+=x;} cout<<"Total: "<<total<<"\nAverage: "<<fixed<<setprecision(2)<<total/7<<"\n";}
