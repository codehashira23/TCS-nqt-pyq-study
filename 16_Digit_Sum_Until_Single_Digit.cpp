/*
   TCS NQT PYQ 16: Digit Sum Until Single Digit
   Source: Verified PYQ
   Difficulty: Easy
   Topics: Math

   QUESTION
   Given a number N, repeatedly sum its digits until the result is a single digit, and print that digit.
...
int main(){long long n; cin>>n; cout<<(n==0?0:1+(n-1)%9)<<"\n";}
