/*
   TCS NQT PYQ 55: Perfect Donation Amount
   Source: Verified PYQ
   Difficulty: Easy
   Topics: Math

   QUESTION
   A charity accepts donations only in "perfect" amounts. A perfect number equals the sum of its proper divisors (excluding itself). Given a donation amount N, check if it is perfect and print true or false.
