/*
   TCS NQT PYQ 06: XOR Coin Denomination
   Source: Verified PYQ
   Difficulty: Easy
   Topics: Bit Manipulation, Array

   QUESTION
   A shopkeeper has coins of several denominations. Initially there are an even number of coins of each type. One coin is lost. Given the list of remaining coins, find the denomination of the lost coin.
...
int main(){ios::sync_with_stdio(false);cin.tie(nullptr);
    int n; cin>>n; long long ans=0,x; while(n-- && cin>>x) ans^=x; cout<<ans<<"\n";
}
