/*
   TCS NQT PYQ 64: Toggle All Bits of a Number
   Source: Verified PYQ
   Difficulty: Easy
   Topics: Bit Manipulation

   QUESTION
   Given a positive integer N, convert it to binary, flip every bit from MSB to LSB, and output the corresponding decimal value.
...
int main(){long long n; cin>>n; long long mask=1; while(mask<=n) mask=(mask<<1)|1; cout<<(mask^n)<<"\n";}
