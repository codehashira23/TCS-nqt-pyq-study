/*
   TCS NQT PYQ 69: Factory Production (Rate Calculation)
   Source: Verified PYQ
   Difficulty: Easy
   Topics: Math

   QUESTION
   A factory produces X units in 24 days. How many units will it produce in D days?
...
int main(){double x,d; cin>>x>>d; cout<<fixed<<setprecision(2)<<(x/24.0)*d<<"\n";}
