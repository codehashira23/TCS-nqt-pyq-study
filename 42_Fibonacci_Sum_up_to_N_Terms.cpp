/*
   TCS NQT PYQ 42: Fibonacci Sum up to N Terms
   Source: Verified PYQ
   Exam/Shift: 29 April 2024 Kolkata Q1
   Difficulty: Easy
   Topics: Math, Dynamic Programming

   QUESTION
   Generate the Fibonacci series and find the sum of its elements up to N terms. F(1)=1, F(2)=1, F(n)=F(n-1)+F(n-2).
...
int main(){int n; cin>>n; long long a=1,b=1,sum=0; for(int i=1;i<=n;i++){long long cur=(i<=2?1:a+b); if(i>2){a=b; b=cur;} sum+=cur;} cout<<sum<<"\n";}
